  ...
  this.stage = new PrimaryStage {
    ...
    val update: Long => Unit = (time: Long) => {
      ...
      if (game.projectiles.isEmpty) {
        ...
        scene = new Scene(2000, 2000) {
          val bulletSprite: Shape = bulletBody(game.projectiles.head.location.x, game.projectiles.head.location.y, Color.Black)
          ...
          content = List(rect, obs1, obs2, obs4, obs5, obs6, obs7, obs8, obs9, obs11, obs12, obs13, obs14, obs15, obs17, obs20, obs21, obs22, playerSprite, bulletSprite)
        }
